...
const questions = [
  ...
  { key: "counsel_q10", label: "What would you like to say? to the world" },
  { key: "counsel_q11", label: "What would you like to say? to Christians in the world" },
  { key: "counsel_q12", label: "What would you like to say? to Muslims in KPP or Pakistan and" },
